...
function account(d){const a=d.account||{},m=d.metrics||{},c=d.daily_counters||{};return `<section class="panel"><h2>共享确定性账户</h2><div class="metric">${money(m.ending_equity)}</div><p>现金 ${money(a.cash)} · 已实现 ${money(a.realized_pnl)}</p><p>今日股票 ${e(c.equity_trades||0)} · 期权 ${e(c.option_trades||0)}</p><p>回撤 ${pct(m.max_drawdown_pct)} · ${e(m.profitability)}</p></section>`}
